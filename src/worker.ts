...
(async () => {
    ...
    const SymbolIsRising = async (): Promise<boolean> => {
        ...
        // return emaLastLargePercent > 2 && emaLastMediumPercent > 1.5 && emaLastSmallPercent > 0.7;
        return emaLastLargePercent > 1.5 && emaLastMediumPercent > 1 && emaLastSmallPercent > 0.45;
    };
